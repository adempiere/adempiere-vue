    ...
    items: [
      {
        ...
        textZH: '富文本',
        link: '/framework/feature/component/rich-editor.md'
      },
      {
        text: 'Markdown Editor',
        textES: 'Editor de Markdown',
        textZH: 'Markdown 编辑器',
        link: '/framework/feature/component/markdown-editor.md'
      },
      {
        text: 'Svg Icon',
        textES: 'Icono Svg',
        textZH: 'Svg Icon 图标',
        link: '/framework/feature/component/svg-icon.md'
      },
      {
        text: 'Clipboard',
        textES: 'Portapapeles',
        textZH: '复制粘贴',
        link: '/framework/feature/component/clipboard.md'
      },
      {
        text: 'Excel',
        textZH: 'Excel',
        link: '/framework/feature/component/excel.md'
      },
      {
        text: 'Pagination',
        textES: 'Paginación',
        textZH: 'Pagination 分页',
        link: '/framework/feature/component/pagination.md'
      },
      {
        text: 'Tree Table',
        textES: 'Tabla de Árbol',
        textZH: 'Tree Table 树形表格',
        link: '/framework/feature/component/tree-table.md'
      }
    ]
  },
  {
    ...
    items: [
      {
        text: 'Svgo',
        link: '/framework/feature/script/svgo.md'
      },
      {
        text: 'New',
        textES: 'Nuevo',
        link: '/framework/feature/script/new.md'
      }
    ]
  }
]
